...
const PoliticasPrivacidad = () => {
    ...
    const addPolicy = async () => {
        ...
        try {
            ...
            formData.append('titulo_politica', sanitizedPolicyName);
        ...
        try {
            ...
            if (!response.ok) {
                ...
                response.json().then(data => {
                    toast.success('Política Eliminada con éxito');
                }).catch(error => {
    ...
    const PolicyNoVigente = async (index) => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                response.json().then(data => {
                    toast.success('Política No Vigente');
                }).catch(error => {
                    toast.warning('Error al obtener la respuesta');
                });
            }
    ...
    const PolicyVigente = async (index) => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                response.json().then(data => {
                    toast.success('Política Vigente');
                }).catch(error => {
                    toast.warning('Error al obtener la respuesta');
                });
            }
    ...
    const updatePolicy = async () => {
        ...
        try {
            ...
            const formData = new FormData();
            formData.append('titulo_politica', sanitizedPolicyTitle);
                    ...
                    >
                        <CardContent>
                            ...
                            <TextField
                                ...
                                InputLabelProps={{
                                    style: {
                                        color: 'text.primary', // Cambia el color del label
                                    },
                                }}
                                value={newPolicy}
                                    ...
                                    <ListItem key={policy._id} alignItems="flex-start">
                                        ...
                                        <Box >
                                            ...
                                            <Box display="flex" alignItems="center" gap={2}>
                                                ...
                                                <Tooltip title="Editar Politica" arrow>
